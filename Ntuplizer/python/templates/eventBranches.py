...
eventBranches = cms.PSet(
    floats = cms.PSet(
        ...
        jet1Eta = cms.string('jet1Eta'),
        jet1Phi = cms.string('jet1Phi'),
        jet2Pt = cms.string('jet2Pt'),
        jet2Eta = cms.string('jet2Eta'),
        jet2Phi = cms.string('jet2Phi'),
        dijetMass = cms.string('dijetMass'),
        dijetPt = cms.string('dijetPt'),
        dijetEta = cms.string('dijetEta'),
        dijetPhi = cms.string('dijetPhi'),
        ),
    bools = cms.PSet(
