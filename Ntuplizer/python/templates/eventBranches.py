...
eventBranches = cms.PSet(
    floats = cms.PSet(
        ...
        uncorrected_pfMETEt = cms.string('uncorrected_pfMETEt'),
        uncorrected_pfMETPhi = cms.string('uncorrected_pfMETPhi'),
...
jetSystematicBranches = cms.PSet(
    ...
    floats = cms.PSet(
        ...
        type1_pfMETPhi_jesUp = cms.string('type1_pfMETPhi_jesUp::fromUncertaintyTool'),
        type1_pfMETEt_jesDown = cms.string('type1_pfMETEt_jesDown::fromUncertaintyTool'),
        type1_pfMETPhi_jesDown = cms.string('type1_pfMETPhi_jesDown::fromUncertaintyTool'),
        type1_pfMETEt_jerUp = cms.string('type1_pfMETEt_jerUp'),
        type1_pfMETPhi_jerUp = cms.string('type1_pfMETPhi_jerUp'),
        type1_pfMETEt_jerDown = cms.string('type1_pfMETEt_jerDown::fromUncertaintyTool'),
        type1_pfMETPhi_jerDown = cms.string('type1_pfMETPhi_jerDown::fromUncertaintyTool'),
        type1_pfMETEt_unclusteredEnUp = cms.string('type1_pfMETEt_unclusteredEnUp::fromUncertaintyTool'),
        type1_pfMETPhi_unclusteredEnUp = cms.string('type1_pfMETPhi_unclusteredEnUp::fromUncertaintyTool'),
        type1_pfMETEt_unclusteredEnDown = cms.string('type1_pfMETEt_unclusteredEnDown::fromUncertaintyTool'),
        type1_pfMETPhi_unclusteredEnDown = cms.string('type1_pfMETPhi_unclusteredEnDown::fromUncertaintyTool'),
        ),
    )
